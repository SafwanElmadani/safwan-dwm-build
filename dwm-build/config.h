...
static const char *fonts[]          = { "JetBrainsMonoNL Nerd Font:size=13:antialias=true:autohint=true",
...
static const char col_gray4[]       = "#282C34"; //"#6b008f"; //"#eeeeee"; // current tag and current window font color
static const char col_cyan[]        = "#AD5E67"; // "#88C0D0"; //"#005577"; // top bar second color(blue) and active window color
...
static Key keys[] = {
	...
	{ ControlMask|Mod1Mask,				XK_c,		spawn,          SHCMD("flatpak run net.giuspen.cherrytree") },
	{ ControlMask|Mod1Mask,				XK_n,		spawn,          SHCMD("flatpak run md.obsidian.Obsidian") },
	{ ControlMask|Mod1Mask,				XK_m,		spawn,          SHCMD("mailspring") },
	{ ControlMask|Mod1Mask,				XK_g,		spawn,          SHCMD("google-chrome-stable") },
	{ ControlMask|Mod1Mask,				XK_o,		spawn,          SHCMD("flatpak run com.obsproject.Studio") },
	...
	{ ControlMask,					    XK_F11,		spawn,		    SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 2%-")},
	{ ControlMask,					    XK_F12,		spawn,		    SHCMD("wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 2%+")},
